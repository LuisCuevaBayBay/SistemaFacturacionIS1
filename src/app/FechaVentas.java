 ...
 * @author Luis Cueva
 */
public class FechaVentas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Escoge fecha para crear Informe de Ventas");
        ...
        getContentPane().add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 130, -1, -1));

        rol.setText("jLabel5");
        getContentPane().add(rol, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 220, -1, -1));

        idv.setText("jLabel6");
        getContentPane().add(idv, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, -1, -1));
 ...
 void validacionVenta(String usuario){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FechaVentas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FechaVentas().setVisible(true);
            }
        });
    }
