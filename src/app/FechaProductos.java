 ...
 * @author Luis Cueva
 */
public class FechaProductos extends javax.swing.JFrame {

    /**
     * Creates new form FechaEmpleados
     */
    public FechaProductos() {
        initComponents();
    ...
    private void initComponents() {
        ...
        fechar.setDateFormatString("MMM d, yyyy");
        getContentPane().add(fechar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, -1, -1));
        ...
        jLabel3.setText("Escoge Fecha para crear el Informe de Productos");
        ...
        getContentPane().add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 260, -1, -1));

        rol.setText("jLabel5");
        getContentPane().add(rol, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 210, -1, -1));

        idv.setText("jLabel6");
        getContentPane().add(idv, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 90, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String date = dFormat.format(fechar.getDate());
         try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FechaProductos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FechaProductos().setVisible(true);
            }
        });
    }
