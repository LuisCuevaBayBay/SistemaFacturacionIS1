 ...
 * @author Luis Cueva
 */
public class FechaClientes extends javax.swing.JFrame {

    /**
     * Creates new form FechaEmpleados
     */
    public FechaClientes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Escoger Fecha para Filtrar Clientes");
        ...
        rol.setText("jLabel3");
        getContentPane().add(rol, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 10, -1, -1));

        idv.setText("jLabel4");
        getContentPane().add(idv, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, -1, -1));
 ...
 void validacionVenta(String usuario){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FechaClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FechaClientes().setVisible(true);
            }
        });
    }
