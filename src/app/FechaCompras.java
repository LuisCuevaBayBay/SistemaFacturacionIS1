 ...
 * @author Luis Cueva
 */
public class FechaCompras extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fecha1.setDateFormatString("MMM d, yyyy");
        getContentPane().add(fecha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, -1, -1));
        ...
        jLabel3.setText("Escoge Fecha para reporte de compras");
        ...
        rol.setText("jLabel4");
        getContentPane().add(rol, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 80, -1, -1));

        nombre.setText("jLabel5");
        getContentPane().add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, -1, -1));

        idv.setText("jLabel6");
        getContentPane().add(idv, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 230, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String date = dFormat.format(fecha1.getDate());
        try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FechaCompras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FechaCompras().setVisible(true);
            }
        });
    }
