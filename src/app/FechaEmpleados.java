 ...
 * @author Luis Cueva
 */
public class FechaEmpleados extends javax.swing.JFrame {

    /**
     * Creates new form FechaEmpleados
     */
    public FechaEmpleados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        fechaE.setDateFormatString("MMM d, yyyy");
        getContentPane().add(fechaE, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 160, -1, -1));
        ...
        jLabel3.setText("Escoge Fecha para crear Reporte de Empleados");
        ...
        rol.setText("jLabel4");
        getContentPane().add(rol, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 260, -1, -1));

        nombre.setText("jLabel5");
        getContentPane().add(nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 80, -1, -1));

        idv.setText("jLabel6");
        getContentPane().add(idv, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 250, -1, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String date = dFormat.format(fechaE.getDate());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FechaEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FechaEmpleados().setVisible(true);
            }
        });
    }
